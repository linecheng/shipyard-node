...
var isSocket = false;//fs.existsSync(socket) ? fs.statSync(socket).isSocket() : false;
var docker;

var tcphost="http://192.168.5.55";
var tcpport=8081;
var serviceKey="VATOuRIehhZ8kZwnDbAzeYK0CyrK5n97gTW6"
